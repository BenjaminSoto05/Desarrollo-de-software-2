        ...
        <div className="px-4 py-10 my-8 text-center bg-white rounded-2xl shadow-lg border-b-4 border-[#0d6efd]">
          <div className="max-w-3xl mx-auto py-6">
            ...
            <p className="text-lg text-gray-500 mb-6 leading-relaxed">
              Conectamos a Presidentes de Junta, Voluntarios y Adultos Mayores
              para construir una comunidad más solidaria, activa y segura para
              todos.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 py-3">
            <div className="bg-[#343a40] text-white rounded-2xl shadow-lg overflow-hidden card-hover">
              <div className="flex flex-col h-full p-8 pb-6">
                <h3 className="pt-12 mt-8 mb-4 text-3xl font-bold leading-tight">
                  Presidentes de Junta
                </h3>
                <p className="text-lg text-white/80">
                  Gestionen las necesidades de su comunidad creando solicitudes
            ...
            <div className="bg-[#ffc107] text-gray-900 rounded-2xl shadow-lg overflow-hidden card-hover">
              <div className="flex flex-col h-full p-8 pb-6">
                ...
                <p className="text-lg">
                  Ofrezcan su tiempo y habilidades para ayudar a quienes más lo
                  necesitan.
                </p>
              </div>
            </div>
            ...
            <div className="bg-[#0d6efd] text-white rounded-2xl shadow-lg overflow-hidden card-hover">
              <div className="flex flex-col h-full p-8 pb-6">
                ...
                <p className="text-lg text-white/80">
                  Reciban la ayuda que necesitan de manera segura y coordinada.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center py-8">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg text-gray-500 mb-3">
                Buscamos a gente que pueda ayudar gratuitamente a adultos
                mayores en sus quehaceres, consiguiendo una sonrisa de parte de
                ellos.
              </p>
              <p className="text-gray-500">
                Día a día miles de adultos mayores no tienen manera de realizar
                ciertas acciones para su vida diaria, pintar una cerca, limpiar
                su auto, cortar su césped, entre otros, llevándolos a
                situaciones desfavorables pero fácilmente reversibles.
              </p>
            </div>
        ...
        <div className="py-10" id="features">
          ...
          <div className="grid md:grid-cols-3 gap-6 py-6">
            {[
              ...
              <div
                key={feat.title}
                className="bg-white p-6 rounded-2xl shadow-sm border h-full"
              >
