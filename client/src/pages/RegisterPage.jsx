...
export default function RegisterPage() {
  ...
  const inputClass =
    'w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0d6efd] focus:border-transparent transition-all text-sm';
        ...
        <div className="max-w-lg mx-auto">
          <div className="bg-white rounded-2xl shadow-lg border overflow-hidden">
            ...
            <div className="p-6">
              {/* Tabs */}
              <div
                className="flex rounded-lg bg-gray-100 p-1 mb-5"
                role="tablist"
              >
                <button
                  role="tab"
              ...
              {error && (
                <div
                  className="bg-red-100 border border-red-300 text-red-800 px-4 py-3 rounded-lg mb-4 text-sm"
                  role="alert"
                >
                  {error}
                  <button
                  ...
                  <>
                    <div>
                      ...
                      >
                        ...
                        <option value="PRESIDENTE_JUNTA">
                          Presidente de Junta Vecinal
                        </option>
                      </select>
                    </div>
                    <div className="grid grid-cols-2 gap-3">
